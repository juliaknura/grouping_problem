...
{
    if (not isValid() or solution.size() not_eq points.size())
        return {};
...
const std::vector<Point> &GroupingProblem::getPoints()
{
    return points;
}

const GroupingProblemParams &GroupingProblem::getParams()
{
    return params;
}
