...
int main()
{
    ...
    problem::GroupingProblem problem2{paramsHappyPath};
    problem2.populate({MP{1, 2}, MP{1, 1}, MP{2, 1}, MP{5, 8}, MP{5, 7}, MP{5, 6}, MP{7, 3}, MP{7, 2}, MP{8, 5}, MP{9, 4}});
    problem::GroupingProblemSolution solution = {0, 0, 0, 1, 1, 1, 2, 2, 2, 2};

    visualization::drawProblemWithSolution(problem2, solution);
